...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        validateCurrentRecord("Error: Location Query Validation Failed", weatherCursor, weatherValues);

        // Перемещаем курсор, чтобы продемонстрировать, что в базе данных содержится только одна строка
...
//        // Предыдущие два вызова можно заменить следующим вызовом,
//        // так как этот метод проверяет курсор,
//        // а затем вызывает метод validateCurrentRecord
//        String error = "Не знаю, для чего нужна эта ошибка";
//        validateCursor(error, cursor, testValues);
